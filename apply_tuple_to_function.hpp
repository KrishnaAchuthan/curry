...
auto selective_get(std::integral_constant<int, I>, std::integral_constant<int, index>, T&& t) {
...
decltype(auto) apply_tuple_to_function(std::integral_constant<int, index> selected_index, int_list<I...>, F&& f, T&& t) {
...
//decltype(auto) apply_tuple_to_function(std::integral_constant<int, index> selected_index, int_list<I...>, const fn_t<F, T1>& f, T2&& t) {
//   using boxtype = std::decay_t<decltype(std::get<index>(std::forward<T>(t)))>;
//   return isabox<boxtype>::box_map(std::get<index>(std::forward<T>(t)), f(get_value(selective_get(std::integral_constant<int, I>(), selected_index, std::forward<T>(t)))...));
//}

template<int index, typename F, typename T1, typename T2, int ...I>
decltype(auto) apply_tuple_to_function(std::integral_constant<int, index> selected_index, int_list<I...>, fn_t<F, T1>&& f, T2&& t) {
...
decltype(auto) apply_tuple_to_function(std::integral_constant<int, -1>, int_list<I...>, F&& f, T&& t) {
   return f(get_value(std::get<I>(std::forward<T>(t)))...);
}

template<typename F, typename T1, typename T2, int ...I>
decltype(auto) apply_tuple_to_function(std::integral_constant<int, -1>, int_list<I...>, fn_t<F, T1>&& f, T2&& t) {
